...
<div class="col-lg-6">
<span class="logo2"> Admission Exam </span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
echo '<a href="#" class="pull-right sub1 btn title3" style="border-radius:10px" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;Login</a>&nbsp;';}
else
{
...
<a href="index.php" style="border-radius:10px" class="pull-right btn sub1 title3"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home</a>&nbsp;
</div></div>
...
<div class="col-md-6 panel" style="background-color:#fff border-color: red green min-height:480px;">

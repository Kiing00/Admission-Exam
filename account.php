...
<div class="row">
<div class="col-lg-6">
<span class="logo2">WELCOME </span></div>
...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out btn-success" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}?>
</div>
</div></div>
<div class="bg">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="email.php"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>&nbsp;Get Email</a></li>
